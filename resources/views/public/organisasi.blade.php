...
@section('content')
    ...
    <section class="mt-16" data-aos="fade-up">
        ...
        <div class="relative mx-auto max-w-7xl px-8 sm:px-12 lg:px-16">
                ...
                <div class="swiper-wrapper">
                    @forelse ($leaders as $leader)
                        <div class="swiper-slide h-auto transition-transform duration-300 hover:z-10">
                            <div class="group relative aspect-[3/4] w-full overflow-hidden rounded-3xl bg-slate-900 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-900/20">
                                {{-- Image --}}
                                ...
                                {{-- Gradient Overlay --}}
                                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-60 transition-opacity duration-300 group-hover:opacity-90"></div>
                                ...
                                <div class="absolute inset-x-0 bottom-0 p-5 sm:p-6 text-left">
                                    ...
                                    <div class="transform transition-transform duration-300 group-hover:-translate-y-1">
                                        <div class="mb-1">
                                            <span class="inline-block rounded-full bg-white/20 px-2.5 py-0.5 text-[10px] font-bold tracking-wider text-white backdrop-blur-md border border-white/10 uppercase shadow-sm">
                                                {{ $leader->position }}
                                            </span>
                                        </div>
                                        {{-- Name: Responsive sizing to handle long names --}}
                                        <h3 class="font-heading text-lg sm:text-xl font-bold text-white leading-tight drop-shadow-md break-words">
                                            {{ $leader->name }}
                                        </h3>
                                    </div>
                    ...
                    @empty
                        <div class="swiper-slide">
                           <div class="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-slate-300 bg-slate-50 p-8 text-center h-full">
            ...
            <button class="leaders-prev absolute -left-3 top-1/2 z-20 -translate-y-1/2 flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-full bg-white/90 text-navy-900 shadow-lg ring-1 ring-slate-900/5 transition-all hover:scale-110 hover:bg-white focus:outline-none lg:-left-5 backdrop-blur-sm">
                <svg class="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                </svg>
            </button>
            <button class="leaders-next absolute -right-3 top-1/2 z-20 -translate-y-1/2 flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-full bg-white/90 text-navy-900 shadow-lg ring-1 ring-slate-900/5 transition-all hover:scale-110 hover:bg-white focus:outline-none lg:-right-5 backdrop-blur-sm">
                <svg class="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
